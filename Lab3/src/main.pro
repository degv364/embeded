TEMPLATE += app
  ...
  QMAKE_CXXFLAGS += -Wall -pedantic -pthread -I/usr/include/gstreamer-1.0 -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include -lgstreamer-1.0 -lgobject-2.0 -lglib-2.0
